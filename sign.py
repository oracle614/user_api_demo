...
conf.read('sign.conf')
appsecret = conf.get('default', 'user')
...
if __name__ == '__main__':
    ...
    p = makeSign({"name":"张14","passwd":"123456"})
    print(p)
    print(md5('name=李六&passwd=e10adc3949ba59abbe56e057f20f883e&appsecret=NTA3ZTU2ZWM5ZmVkYTVmMDBkMDM3YTBi'))
    print(checkSign(p))
